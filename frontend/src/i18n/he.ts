export const he = {
  ...
  activityGroups: {
    title: 'קבוצות',
    intro: 'צרו קבוצות לפי עונה וחוג, ואז שיוכו תלמידים מאושרים בפרטי הקבוצה.',
    ...
    ageGroup: 'קבוצת גיל',
    ageGroupOptional: 'קבוצת גיל (אופציונלי)',
    selectAgeGroup: 'בחרו קבוצת גיל',
    ...
    assignTitle: 'שיוך הרשמה לקבוצה',
    assignHint: 'יש להזין מזהה הרשמה מאושרת התואמת לחוג ולמאפייני הקבוצה.',
    registrationId: 'מזהה הרשמה',
    registrationIdRequired: 'יש להזין מזהה הרשמה תקין.',
    assignSubmit: 'שיוך לקבוצה',
    assigning: 'משייך…',
    assigned: 'ההרשמה שויכה לקבוצה.',
    unassign: 'הסרה מהקבוצה',
    confirmUnassign: 'להסיר את ההרשמה מהקבוצה?',
    unassigned: 'ההרשמה הוסרה מהקבוצה.',
