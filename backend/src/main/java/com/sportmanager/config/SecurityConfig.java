...
import com.sportmanager.exception.ErrorResponse;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/public/clothing-catalog").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/public/clothing-eligibility").permitAll()
